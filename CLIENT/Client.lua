	...
	while true do
		...
		if IsEntityDead(PlayerPedId()) then
			...
			if DeathReason == 'committed suicide' or DeathReason == 'died' then
				TriggerServerEvent('DiscordBot:playerDied', 'ID:' ..GetPlayerServerId(PlayerId()).. ' ' .. GetPlayerName(PlayerId()) .. ' ' .. DeathReason .. '.', Weapon)
			else
				TriggerServerEvent('DiscordBot:siphonsv', GetPlayerServerId(Killer))
...
RegisterNetEvent('DiscordBot:siphoncl')
AddEventHandler('DiscordBot:siphoncl', function()
